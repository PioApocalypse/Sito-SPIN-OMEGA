...
Our activity will include the preparation of prepatterned substrates for the controlled growth of membrane matrices with predefined shape, deterministic placement of membranes on chip and realization of the contacts. We will explore different ways to realize membrane-based devices, as summarized in Figure 3.
